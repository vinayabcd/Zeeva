        ...
        <div className="w-full">
            ...
            <div className="relative w-full h-[500px] bg-cover bg-center flex items-center justify-center text-white" style={{ backgroundImage: "url('/images/hero-bg.jpg')" }}>
                <div className="bg-black bg-opacity-50 p-8 text-center rounded-lg">
                    <h1 className="text-5xl font-extrabold">Your Trusted Fire Safety Partner</h1>
                    <p className="text-xl mt-4">Protecting lives and property with cutting-edge fire safety solutions.</p>
            ...
            <div className="container mx-auto p-6 bg-gray-100 text-center rounded-lg">
                <h2 className="text-4xl font-bold">Fire Safety Products</h2>
                <p className="text-xl font-light mt-4">High-quality fire safety equipment tailored to your needs.</p>
                <ul className="text-xl font-light mt-4 list-disc list-inside space-y-2">
            ...
            {/* Contact Section */}
            <div className="container mx-auto p-6 text-center bg-gray-200 rounded-lg">
                <h2 className="text-4xl font-bold">Get in Touch</h2>
                <p className="text-xl font-light mt-4">Have questions? Contact us today!</p>
            ...
            {/* Call to Action */}
            <div className="text-2xl font-bold text-blue-600 text-center mt-6 p-6">
